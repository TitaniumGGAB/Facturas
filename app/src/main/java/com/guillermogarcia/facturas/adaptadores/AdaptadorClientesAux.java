...
public class AdaptadorClientesAux extends RecyclerView.Adapter<AdaptadorClientesAux.ClienteViewHolder>  implements View.OnClickListener{

    private final ArrayList<Cliente> clientes;
    private final Context context;
    private View.OnClickListener listener;

    public AdaptadorClientesAux(Context context, ArrayList<Cliente> clientesRecibidos) {
    ...
    public ClienteViewHolder onCreateViewHolder (@NonNull ViewGroup parent, int viewType){
        ...
        return new AdaptadorClientesAux.ClienteViewHolder(itemView, context);
    }
